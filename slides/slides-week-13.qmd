...
::: notes
https://rin3fall2024.rfortherestofus.com/slides/slides-week-13.html
:::
...
pre_survey <- read_sheet("https://docs.google.com/spreadsheets/d/19Ny92IGg0ZzIqiLs7QywaGF-Y85HQZn1iIIXN4I_tpg/edit#gid=1201619159") |>
  clean_names() |>
  filter(timestamp > as.Date("2024-09-01")) |>
...
::: notes
https://rfortherestofus.com/courses/r-in-3-months-spring-2024/lessons/r-in-3-months-progress-survey
:::
...
::: {.notes}
https://bit.ly/r3m-f24-graduation
:::
...
![](https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExdmY4MmFoemhtdmJsNGg4dmtwNmR4dXloemJmdnNmYmVrYWU4eDU0NyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/SCcfZ11oxj4D4HSKlr/giphy.gif){fig-align="center"}

## Planning with Pseudo Code

-   Use plain language **before** you code == comments!
...
-   It also had a [recent controversy related to selling data to OpenAI](https://www.tomshardware.com/tech-industry/artificial-intelligence/stack-overflow-bans-users-en-masse-for-rebelling-against-openai-partnership-users-banned-for-deleting-answers-to-prevent-them-being-used-to-train-chatgpt), with many users deleting answers they had previously posted
...
2.  Any 1-on-1s with your coaches must be completed by end of December
...
1. Everyone has access to Using Git and GitHub with R (if you purchased it, send me an email for a refund)
